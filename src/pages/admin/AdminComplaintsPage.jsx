...
export default function AdminComplaintsPage() {
  ...
  return (
    <>
      <style>{`
        .ac-wrap { min-height:100vh; background:#f7f5f0; font-family:'Segoe UI',sans-serif; padding:28px 32px; }
        ...
        @media(max-width:700px) { .ac-wrap { padding:16px; } .ac-table { overflow-x:auto; } }
      `}</style>
