...
export default function LoanSchedulePage() {
  ...
  return (
    <div style={s.page}>
      <style>{`
        .ls-nav { background:#1f4d1f; padding:12px 40px; display:flex; justify-content:space-between; align-items:center; color:#fff; position:sticky; top:0; z-index:100; }
        .ls-nav-left { display:flex; align-items:center; gap:12px; cursor:pointer; flex-shrink:0; }
        .ls-nav-links { display:flex; gap:24px; align-items:center; }
