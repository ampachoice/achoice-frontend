    ...
    <div style={s.page}>
      ...
      <nav className="ll-nav">
        ...
        <div className="ll-nav-links">
          <span className="ll-nav-link" onClick={() => navigate("/")}>
            Home
          </span>
          <span
          ...
          <span className="ll-nav-link" onClick={() => navigate("/orders")}>
            My Orders
          </span>
        </div>
          ...
          <>
            ...
            <div style={s.totalCard}>
              ...
              <div style={s.totalCardRow}>
                <div style={s.totalAmount}>
                  ₦
                  {Number(summary?.total_due_this_month || 0).toLocaleString(
                    undefined,
                    {
            ...
            {loans.length === 0 ? (
              <div style={s.emptyBox}>
                ...
                <p style={s.emptyText}>
                  Apply for a quick, affordable loan to grow your farm or
                  business.
                </p>
                <button
                  style={s.applyBtn}
                    ...
                    <div style={s.loanCardRight}>
                      ...
                      {loan.is_disbursed ? (
                        <div style={s.loanBalance}>
                          ₦
                          {Number(loan.balance).toLocaleString(undefined, {
                            minimumFractionDigits: 2,
                          })}
                        </div>
                      ) : (
